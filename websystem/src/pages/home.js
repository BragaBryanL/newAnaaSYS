  ...
  useEffect(() => {
    const fetchData = async () => {
      const [
        ...
        fetch("http://localhost:5000/api/faculty/count").then((res) => res.json()),
        fetch("http://localhost:5000/api/departments/count").then((res) => res.json()),
        fetch("http://localhost:5000/api/consultations/count").then((res) => res.json()),
        fetch("http://localhost:5000/api/faculty/status-counts").then((res) => res.json()),
        fetch("http://localhost:5000/api/consultations/monthly").then((res) => res.json()),
        fetch("http://localhost:5000/api/notifications").then((res) => res.json()),
      ]);
      setFacultyCount(facultyRes.total);
      setDepartmentCount(deptRes.total);
      setConsultationCount(consRes.total);
      setStatusCounts(statusRes);
      setMonthlyConsultations(monthlyRes);
